...
export const AUTH = {
    ...
    SPOTIFY_AUTH_URL: "https://accounts.spotify.com/authorize/?client_id=92cc66d8a9754a6892b952da2a7eefab&response_type=code&redirect_uri=http://localhost:8080/callback&scope=user-read-playback-state,user-modify-playback-state,user-read-private&show_dialog=true",
